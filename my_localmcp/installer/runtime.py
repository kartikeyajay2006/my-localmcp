...
def location_for_venv(
    ...
    return RuntimeLocation(
        ...
        cli_executable=executable_dir / f"my-localmcp{suffix}",
        server_executable=executable_dir / f"my-localmcp-server{suffix}",
    )
...
def build_candidate(
    ...
    *,
    ...
    if reporter is not None:
        reporter.info("Installing my-localmcp into the candidate runtime.")
