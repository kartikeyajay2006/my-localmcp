...
def _runtime_imports(paths: ManagedPaths) -> bool:
    # spawns the managed venv's python and tries `import my_localmcp`; any failure (missing binary, bad venv, timeout) -> False, never raises
    try:
        result = subprocess.run(
            [
                str(paths.python_executable),
                "-c",
                "import my_localmcp; print(my_localmcp.__version__)",
            ],
