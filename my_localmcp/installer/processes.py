...
def _registered_command_roots(
    ...
    # registration command_root (absolute, containing "my-localmcp") -> (normalized_root, source) pairs, for matching a live process's command line
    ...
    for registration in registrations:
        ...
        if "my-localmcp" not in normalized:
            continue
        roots.append(
