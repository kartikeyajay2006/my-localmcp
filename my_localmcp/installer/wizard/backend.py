...
# my_localmcp.installer.output.FULL_WIPE_CONFIRMATION, duplicated here so the
# stdlib-only UI layer never has to import the psutil-dependent installer.
FULL_WIPE_PHRASE = "DELETE ALL MY-LOCALMCP DATA"

# Client surface identifiers (match my_localmcp.installer / client_setup keys).
