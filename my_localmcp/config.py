...
APP_DIR = Path(os.environ.get("MY_LOCALMCP_HOME", Path.home() / ".my-localmcp")).expanduser()
...
CONFIG_PATH = Path(os.environ.get("MY_LOCALMCP_CONFIG", CONFIG_DIR / "config.yaml")).expanduser()
...
def config_path() -> Path:
    ...
    explicit = os.environ.get("MY_LOCALMCP_CONFIG")
    if explicit:
...
DEFAULT_CONFIG: dict[str, Any] = {
    ...
    "repo": {
        ...
        "exclude_dirs": [
            ...
            ".my-localmcp", ".pytest_cache", ".claude",
        ],
